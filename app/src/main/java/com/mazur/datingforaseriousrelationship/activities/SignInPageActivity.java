...
import com.mazur.datingforaseriousrelationship.utils.Utility;
...
public class SignInPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YandexMetricaConfig config = YandexMetricaConfig.newConfigBuilder("c3b0e299-188c-406e-87d5-58de9d557eac").build();
