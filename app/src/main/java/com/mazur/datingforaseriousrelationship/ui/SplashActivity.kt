...
import com.mazur.datingforaseriousrelationship.*
import com.mazur.datingforaseriousrelationship._core.BaseActivity
import com.mazur.datingforaseriousrelationship.activities.MainActivity
import com.mazur.datingforaseriousrelationship.activities.SignInPageActivity
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                if (url.contains("/money")) {
                    ...
                    startActivity(Intent(this@SplashActivity, SignInPageActivity::class.java))
                    finish()
                }
